...
const CATEGORY_OPTIONS = [
  ...
  { key: 'food-restaurant', label: 'Food & Restaurant' },
  { key: 'hotels', label: 'Hotels' },
  // ── Embassy categories ──────────────────────────────────
  { key: 'iran-embassy', label: 'Iran Embassy' },
  { key: 'malaysia-embassy', label: 'Malaysia Embassy' },
  { key: 'usa-embassy', label: 'USA Embassy' },
  { key: 'uk-embassy', label: 'UK Embassy' },
  { key: 'indonesia-embassy', label: 'Indonesia Embassy' },
  { key: 'australia-embassy', label: 'Australia Embassy' },
  { key: 'france-embassy', label: 'France Embassy' },
  { key: 'spain-embassy', label: 'Spain Embassy' },
  { key: 'sweden-embassy', label: 'Sweden Embassy' },
  { key: 'italy-embassy', label: 'Italy Embassy' },
  { key: 'china-embassy', label: 'China Embassy' },
  { key: 'korea-embassy', label: 'South Korea Embassy' },
  { key: 'russia-embassy', label: 'Russia Embassy' },
  { key: 'saudi-embassy', label: 'Saudi Embassy' },
  { key: 'turkey-embassy', label: 'Turkey Embassy' },
  { key: 'romania-embassy', label: 'Romania Embassy' },
